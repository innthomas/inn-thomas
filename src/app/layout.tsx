...
export const metadata: Metadata = {
  title: "InnThomas | Portfolio",
  description:
    "Innocent Thomas's portfolio and general information page. Innocent is a full stack developer with a bias for nextJS and other javascript tools.",
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="!scroll-smooth">
      <body
        className={`${inter.className}bg-gray-50 text-gray-950 relative pt-28 sm:36 dark:bg-gray-900 dark:text-gray-50 dark:text-opacity-90`}
      >
